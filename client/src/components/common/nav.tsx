  ...
  return (
    <Link
      ...
      className={cn(
        ...
        checkActiveNav(href, subLink) && "bg-primary/10 text-primary font-semibold",
    ...
    <Collapsible defaultOpen={isChildActive}>
      <CollapsibleTrigger
        className={cn(
          ...
          isChildActive && "bg-accent text-accent-foreground bg-accent font-semibold"
        )}
      >
        <div className="mr-2">{icon}</div>
        {title}
        ...
        <TooltipTrigger asChild>
          <DropdownMenuTrigger asChild>
            <Button
              variant={"ghost"}
              size="icon"
              className={cn("h-12 w-12", isChildActive && "bg-primary/10 text-primary")}
            >
              {icon}
            </Button>
          </DropdownMenuTrigger>
