...
describe('AuthController', () => {
  ...
  beforeEach(() => {
    ...
    authServiceMock = {
      ...
      generateCookieToken: jest.fn(),
    } as unknown as jest.Mocked<AuthService>;

    (AuthService as jest.Mock).mockReturnValue(authServiceMock);
  ...
  describe('login', () => {
    it('should login user successfully', async () => {
      ...
      authServiceMock.generateCookieToken.mockImplementation((res: any) => {
        res.locals = { token: 'mockToken123' };
        return res;
      });
  ...
  describe('sendVerificationLink', () => {
    it('should send verification link successfully', async () => {
      ...
      authServiceMock.getAuthToken.mockReturnValue('mockToken123');
